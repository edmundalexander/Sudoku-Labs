...
import { SOUND_PACKS } from "./constants.js";
...
export const SoundManager = {
  ...
  play(type) {
    ...
    if (!this.ctx) return;
    const handler =
      this.packHandlers[this.currentPack] || this.packHandlers.classic;
